...
const EnvironmentM = () => {
  ...
  const cards = [
    ...
    },
    {
      ...
      description:
        "With over 20 MWp of rooftop solar installed and counting, we’re offsetting over ~21,000 tonnes of CO₂ emissions every year. From LED retrofits to smarter energy monitoring, we’re improving efficiency across our parks and moving steadily toward our long-term (2050) operational net-zero pathway. In parallel, we’re building a clearer baseline for tracking and reducing construction-related emissions.",
      keypoints: [
